...
const monthlyData = [
  { month: 'Jul', emails: 280, events: 2, newContacts: 15, engagement: 58 },
  { month: 'Aug', emails: 320, events: 3, newContacts: 22, engagement: 62 },
  { month: 'Sep', emails: 380, events: 4, newContacts: 18, engagement: 65 },
  { month: 'Oct', emails: 420, events: 3, newContacts: 25, engagement: 68 },
  { month: 'Nov', emails: 390, events: 2, newContacts: 12, engagement: 64 },
  { month: 'Dec', emails: 280, events: 1, newContacts: 8, engagement: 55 },
  { month: 'Jan', emails: 450, events: 3, newContacts: 20, engagement: 72 },
];
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Select defaultValue="6m"><SelectTrigger className="w-[140px]"><SelectValue placeholder="Time period" /></SelectTrigger><SelectContent><SelectItem value="7d">Last 7 days</SelectItem><SelectItem value="30d">Last 30 days</SelectItem><SelectItem value="3m">Last 3 months</SelectItem><SelectItem value="6m">Last 6 months</SelectItem><SelectItem value="1y">Last year</SelectItem></SelectContent></Select>
          <Button variant="outline" size="sm"><Download className="h-4 w-4 mr-2" />Export Report</Button>
        </div>
      </div>

      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card><CardHeader className="pb-2"><CardDescription>Total Emails Sent</CardDescription><CardTitle className="text-3xl">2,520</CardTitle></CardHeader><CardContent><div className="flex items-center gap-1 text-sm text-success"><TrendingUp className="h-4 w-4" /><span>+12.5% from last period</span></div></CardContent></Card>
        <Card><CardHeader className="pb-2"><CardDescription>Average Open Rate</CardDescription><CardTitle className="text-3xl">78.2%</CardTitle></CardHeader><CardContent><div className="flex items-center gap-1 text-sm text-success"><TrendingUp className="h-4 w-4" /><span>+5.3% from last period</span></div></CardContent></Card>
        <Card><CardHeader className="pb-2"><CardDescription>Events Conducted</CardDescription><CardTitle className="text-3xl">18</CardTitle></CardHeader><CardContent><div className="flex items-center gap-1 text-sm text-destructive"><TrendingDown className="h-4 w-4" /><span>-2 from last period</span></div></CardContent></Card>
        <Card><CardHeader className="pb-2"><CardDescription>Contacts Engaged</CardDescription><CardTitle className="text-3xl">892</CardTitle></CardHeader><CardContent><div className="flex items-center gap-1 text-sm text-success"><TrendingUp className="h-4 w-4" /><span>+8.7% from last period</span></div></CardContent></Card>
      </div>
      ...
      <Tabs defaultValue="overview">
        ...
        <TabsContent value="overview" className="space-y-6 mt-6">
          ...
          <div className="grid gap-6 lg:grid-cols-2"><ContactTypeChart /><EventPerformanceChart /></div>
        </TabsContent>
        ...
        <TabsContent value="events" className="mt-6"><EventPerformanceChart /></TabsContent>
        <TabsContent value="engagement" className="mt-6"><EngagementChart /></TabsContent>
      </Tabs>
    </div>
  );
}
